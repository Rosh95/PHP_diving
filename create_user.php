 ...
 if (is_not_logged_in() || is_not_admin(get_authenticated_user())) {
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <option><?php echo $status_value; ?></option>
                                    <?php endforeach; ?>
                                    </select>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group input-group-lg bg-white shadow-inset-2 mb-2">
                                            ...
                                            <input type="text" id="simpleinput" class="form-control border-left-0 bg-transparent pl-0" name = 'vk'>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <!-- telegram -->
                                        <div class="input-group input-group-lg bg-white shadow-inset-2 mb-2">
                                            ...
                                            <input type="text" id="simpleinput" class="form-control border-left-0 bg-transparent pl-0" name = 'telegram'>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <!-- instagram -->
                                        <div class="input-group input-group-lg bg-white shadow-inset-2 mb-2">
                                            ...
                                            <input type="text" id="simpleinput" class="form-control border-left-0 bg-transparent pl-0" name = 'instagram'>
                                        </div>
                                    </div>
